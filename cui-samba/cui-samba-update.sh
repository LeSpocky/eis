...
makeConfigFile()
{
    ...
    printgroup "SAMBA_SHARE_HOMES_COMMENT"
    printgroup "SAMBA_SHARE_HOMES_ACTIVE"
    printgroup "SAMBA_SHARE_HOMES_ADVANCED_SETTINGS"
    printgroup "SAMBA_SHARE_HOMES_CREATE_MASK"
    printgroup "SAMBA_SHARE_HOMES_DIRECTORY_MASK"
    printgroup "SAMBA_SHARE_HOMES_WRITEABLE"
    printgroup "SAMBA_SHARE_HOMES_VALID_USERS"
    printgroup "SAMBA_SHARE_HOMES_FORCE_CREATE_MODE"
    printgroup "SAMBA_SHARE_HOMES_FORCE_DIRECTORY_MODE"
