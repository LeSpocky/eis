...
SAMBA_SHARE_2_DIRECTORY_PATH=${DIRECTORY_PATH}
SAMBA_SHARE_2_WRITEABLE=${WRITEABLE}
SAMBA_SHARE_2_BROWSEABLE=${BROWSEABLE}
SAMBA_SHARE_2_VALID_USERS=${VALID_USERS}
SAMBA_SHARE_2_FORCE_CREATE_MODE=${FORCE_CREATE_MODE}
SAMBA_SHARE_2_FORCE_DIRECTORY_MODE=${FORCE_DIRECTORY_MODE}
...
makeConfigFile()
{
    ...
    while [ "${idx}" -le "${SAMBA_SHARE_N}" ] ; do
        ...
        printvar "SAMBA_SHARE_${idx}_ACTIVE"
        ...
        printvar "SAMBA_SHARE_${idx}_BROWSEABLE"
        printvar "SAMBA_SHARE_${idx}_VALID_USERS"
        printvar "SAMBA_SHARE_${idx}_FORCE_CREATE_MODE"
        printvar "SAMBA_SHARE_${idx}_FORCE_DIRECTORY_MODE"
        idx=$((idx+1))
    done
