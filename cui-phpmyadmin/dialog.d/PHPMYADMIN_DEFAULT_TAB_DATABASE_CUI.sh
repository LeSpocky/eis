#!/bin/bash
#------------------------------------------------------------------------------
# /var/install/dialog.d/PHPMYADMIN_DEFAULT_TAB_DATABASE_CUI.sh - script dialog for ece
#
...
exec_dialog()
{
    ...
    sellist="db_details_structure.php,db_details.php,db_search.php"

    ece_select_list_dlg "$win" "Default tab database" "$sellist"
}
