...
# Last update:  $Id: PHPMYADMIN_DEFAULT_PROP_DISPLAY_CUI.sh 21582 2009-10-17 09:17:35Z alex $
#
...
exec_dialog()
{
    ...
    sellist="horizontal,vertical"

    ece_select_list_dlg "$win" "Default display of properties" "$sellist"
}
