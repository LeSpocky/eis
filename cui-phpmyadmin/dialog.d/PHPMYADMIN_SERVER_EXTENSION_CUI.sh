...
# Last update:  $Id: PHPMYADMIN_SERVER_EXTENSION_CUI.sh 21582 2009-10-17 09:17:35Z alex $
#
...
{ 
    ...
    sellist="mysql,mysqli"

    ece_select_list_dlg "$win" "MySQL server extension to use" "$sellist"
}
