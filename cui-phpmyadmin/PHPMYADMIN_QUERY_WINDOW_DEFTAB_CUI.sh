...
# Last update:  $Id: PHPMYADMIN_QUERY_WINDOW_DEFTAB_CUI.sh 21582 2009-10-17 09:17:35Z alex $
#
...
exec_dialog()
{
    ...
    sellist="sql,files,history,full"

    ece_select_list_dlg "$win" "Default query tab" "$sellist"
}
