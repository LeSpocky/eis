...
function init()
{
    ...
    then
        ...
        cui_window_settext        "$mainwin" "Eisfair - Curses User Interface packages"
        cui_window_setlstatustext "$mainwin" "Commands: F4=View F7=Install/Upgrade F8=Uninstall F10=Exit"
